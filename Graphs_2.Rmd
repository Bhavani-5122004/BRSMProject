...
# QQ Plots
qqnorm(aggregated_matrix$IR_Memorability, main = "Q-Q Plot: IR Memorability")
qqline(aggregated_matrix$IR_Memorability)

qqnorm(aggregated_matrix$WR_Accuracy, main = "Q-Q Plot: WR Accuracy")
qqline(aggregated_matrix$WR_Accuracy)

# Shapiro Wilk
shapiro.test(aggregated_matrix$IR_Memorability)
shapiro.test(aggregated_matrix$WR_Accuracy)
```
