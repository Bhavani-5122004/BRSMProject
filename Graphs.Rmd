...
ggplot(aggregated_matrix, aes(x = IR_Memorability)) +
  ...
  labs(
    title = "Distribution of IR Memorability Scores by Condition",
    x = "IR Memorability",
    y = "Count"
  ) +
  theme_minimal()
...
```{r}
# Summarize data for Interaction Plots
...
# Graph 8 (H3b): Interaction Plot for WR [cite: 61, 62]
...
# Summarize effect magnitudes across conditions using standardized standard error/differences
...
# Build full numeric correlation data
...
# Reverse rows so axes match visually
